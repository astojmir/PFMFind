...
readhist1 <- function(file, Tfile, title0, range)
  {
    ...
    plot(mids0[1:range], intensities0[1:range], type="l", xlab="Bin Size",
         ylab="Relative Frequency", log="xy")
...
skip0 <- readhist1("sprot_10_5.txt", "sprot_10_5_T.txt", "SwissProt, m=10, K=5", 100)
